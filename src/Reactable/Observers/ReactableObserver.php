...
class ReactableObserver
{
    public function created(ReactableContract $reactable): void
    {
    ...
    private function shouldRegisterAsReactantOnCreate(ReactableContract $reactable): bool
    {
